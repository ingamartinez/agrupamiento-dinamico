...
jQuery.extend({
	...
	dobPicker: function(params) {
		...
		$(params.daySelector).append('<option selected disabled>' + params.dayDefault + '</option>');
		$(params.monthSelector).append('<option selected disabled>' + params.monthDefault + '</option>');
		$(params.yearSelector).append('<option selected disabled>' + params.yearDefault + '</option>');
		...
		for (i = moment().format('YYYY'); i >= moment().subtract(100,'years').format('YYYY'); i--) {
